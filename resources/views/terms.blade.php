			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						...
						<p>If the company receives payment for an order that has already expired, the company reserves the right to recalculate the Bitcoin to exchange rate at the time of processing the transfer to the customer.  This may result in the customer receiving less bitcoins than the original ordered amount.</p>
						<h3>Choice of Law</h3>
						<p>This Agreement, and its application and interpretation, shall be governed exclusively by the laws of London, without regard to its conflict of law rules. You consent to the exclusive jurisdiction of the federal and state courts located in or near Windsor, Ontario for any dispute arising under this Agreement.</p>
						<h3>Security</h3>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="action-text">
								...
								<p class="lead">Open account for free and earning Bitcoins!</p>
							</div>
