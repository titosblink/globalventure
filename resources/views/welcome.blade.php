                        ...
                        <div class="slider-content">
                            <div class="container">
                                <div class="slider-text text-center">
                                    ...
                                    <p>
                                        <a href="/aboutus" class="slider btn btn-primary">Learn more</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row features-row">
                        ...
                        <div class="feature-box col-md-4 col-sm-12">
                            ...
                            <div class="feature-box-content">
                                ...
                                <p>Join us today and get full access to your wallet. Send and receive bitcoin with it Global Ventures BTC Wallet</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row about-content">
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-6">
                            ...
                            <p class="about-text">
                                A place for everyone who wants to simply join the elites in Bitcoins. Deposit your bitcoin into your Global Ventures custom wallet and start earning immediately. Instant buy/sell of Bitcoins at fair price is
                                    ...
                                    <ul class="pricing-wrapper">
                                        ...
                                        <li data-type="buy" class="is-visible">
                                            ...
                                            <footer class="pricing-footer">
                                                <a href="/logins" class="btn btn-primary">ORDER NOW</a>
                                            </footer>
                                        </li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <p class="action-btn"><a class="btn btn-primary" href="/registers">Register Now</a></p>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12" style="color: #fff; background-color: rgba(0, 0, 0, 0.5); z-index: 2; text-align: center;">
                                ...
                                <div>
                                    ...
                                    <p class="action-btn">
                                        <a href="/registers" class="btn btn-primary">get link</a>
                                    </p>
                                </div>
                            </div>
                        </div>
